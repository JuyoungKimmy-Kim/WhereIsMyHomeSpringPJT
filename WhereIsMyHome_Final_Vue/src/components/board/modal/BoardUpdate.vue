<template>
    <div class="modal fade modal-xl" id="boardUpdateModal" tabindex="-1" aria-labelledby="UpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="UpdateModalLabel">수정하기</h5>
            ...
            <div class="modal-body">
                <div class="input-group input-group-static mb-4">
                    <label>제목</label>
                    <input v-model="title" type="text" class="form-control" aria-label="제목">
                </div>
                <div>
                    <label>내용</label>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn bg-gradient-primary mb-0" @click="tokenCheck">수정</button>
            </div>
...
export default {
    ...
    methods: {
        ...mapActions(boardStore, ["updatePost"]),
    ...
    mounted() {
        ClassicEditor.create(document.getElementById("UpdateEditor"))
        .then(res => {
            this.CKEditor = res;
        });
    },
