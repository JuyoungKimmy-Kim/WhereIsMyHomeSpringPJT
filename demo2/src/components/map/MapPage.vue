...
export default {
    ...
    methods: {
        ...
        searchPlaces(){
        var keyword = "이태원"//document.getElementById('keyword').value;
        ...
        this.kakao.ps.keywordSearch( keyword, this.placesSearchCB); 
        },
...
#menu_wrap {position:absolute;top:130px;left:0;bottom:0;width:450px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;z-index: 1;font-size:12px;border-radius: 10px;}
