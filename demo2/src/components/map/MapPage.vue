...
#menu_wrap {position:absolute;top:130px;left:0;bottom:0;width:auto;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;z-index: 1;font-size:12px;border-radius: 10px;}
