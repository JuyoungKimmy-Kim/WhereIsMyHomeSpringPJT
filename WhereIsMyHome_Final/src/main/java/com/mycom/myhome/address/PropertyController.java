...
public class PropertyController {
	...
	@GetMapping("/property/{gugunCode}")
	private List<PropertyDto> searchByGugun(@PathVariable String gugunCode) {
		System.out.println("PropertyController - Search By Gugun");
		return service.searchByGugun(gugunCode);
	}
